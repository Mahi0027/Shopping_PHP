...
$ins = "insert into aboutus set aboutus_title = '".$_POST['atitle']."', aboutus_description='".$_POST['adesc']."' ";
...
<div class="inner">
	<div class="login">
		...
		<form method="post">
			...
			<div class="new_text"><input type="text" name="atitle" class="input"><br><br></div>

			<div class="new_head">Description</div>
			<div class="new_text"><textarea class="inputtxtarea" name="adesc"></textarea>  <br><br><br></div>
