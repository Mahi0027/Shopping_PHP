...
<body class=body>
	<div class="main">
		...
		<div class="row3">
			...
			<div class="r3_about">
				<div class="about" align ="center">INTERVIEW QUESTIONS</div>
				<div class="contain1">	
				<div class="inter">	Question  <input type="textfield" name="uname"><br><br>
					Answer  <input type="textfield" name="email"><br><br></div>
